...
namespace Gizmo.NodeFrameworkUI
{
    ...
    public class DecimalBox : UITextBox
    {
        ...
        {
            DefaultStyleKey = typeof(DecimalBox);
        }
        ...
        protected decimal IncrementValue(decimal value, decimal increment)
        {
            return value + increment;
        }

        protected decimal DecrementValue(decimal value, decimal increment)
        {
            return value - increment;
        }

        protected decimal? ConvertTextToValue(string text)
        {
            decimal? result = null;
        ...
        protected decimal? TextToValue(string currentText, string text)
        {
            decimal? result;
            decimal outputValue = new decimal();
            if (!decimal.TryParse(text, NumberStyle, CultureInfo, out outputValue))
            {
                bool ShowValidationError = true;

                if (!decimal.TryParse(currentText, NumberStyle, CultureInfo, out decimal currentValueTextOutputValue))
                {
        ...
        protected void ValidateDefaultMinMax(decimal? value)
        {
        ...
        private bool IsLowerThan(decimal? first, decimal? second)
        {
        ...
        private bool IsGreaterThan(decimal? first, decimal? second)
        {
            if (first == null || second == null)
                return false;
        ...
        public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register("Minimum", typeof(decimal), typeof(DecimalBox), new UIPropertyMetadata(decimal.MinValue, MinimumPropertyChanged));
        public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register("Maximum", typeof(decimal), typeof(DecimalBox), new UIPropertyMetadata(decimal.MaxValue, MaximumPropertyChanged));
        public static readonly DependencyProperty IncrementProperty = DependencyProperty.Register("Increment", typeof(decimal), typeof(DecimalBox), new UIPropertyMetadata(0.1m, IncrementPropertyChanged));
        public static readonly DependencyProperty DefaultValueProperty = DependencyProperty.Register("DefaultValue", typeof(decimal), typeof(DecimalBox), new UIPropertyMetadata(0.0m));
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register("Value", typeof(decimal), typeof(DecimalBox), new UIPropertyMetadata(0.0m, ValuePropertyChanged));
        public static readonly DependencyProperty CultureInfoProperty = DependencyProperty.Register("CultureInfo", typeof(CultureInfo), typeof(DecimalBox), new UIPropertyMetadata(CultureInfo.CurrentCulture, OnCultureInfoChanged));
        public static readonly DependencyProperty FormatStringProperty = DependencyProperty.Register("FormatString", typeof(string), typeof(DecimalBox), new UIPropertyMetadata(String.Empty, OnFormatStringChanged));
        public static readonly DependencyProperty UpdateValueOnEnterKeyProperty = DependencyProperty.Register("UpdateValueOnEnterKey", typeof(bool), typeof(DecimalBox), new FrameworkPropertyMetadata(false, OnUpdateValueOnEnterKeyChanged));
        public static readonly DependencyProperty NumberStyleProperty = DependencyProperty.Register("NumberStyle", typeof(NumberStyles), typeof(DecimalBox), new UIPropertyMetadata(NumberStyles.Any));
        public static readonly DependencyProperty ShowControlButtonsProperty = DependencyProperty.Register("ShowControlButtons", typeof(bool), typeof(DecimalBox), new UIPropertyMetadata(false, ShowControlButtonsPropertyChanged));
        public static readonly DependencyProperty CanMoveUpProperty = DependencyProperty.Register("CanMoveUp", typeof(bool), typeof(DecimalBox), new UIPropertyMetadata(true));
        public static readonly DependencyProperty CanMoveDownProperty = DependencyProperty.Register("CanMoveDown", typeof(bool), typeof(DecimalBox), new UIPropertyMetadata(true));
        #endregion
        ...
        {
            if (o is DecimalBox TextBox)
                TextBox.OnMinimumPropertyChanged((decimal)e.OldValue, (decimal)e.NewValue);
        }

        protected void OnMinimumPropertyChanged(decimal oldValue, decimal newValue)
        { }

        private static void MaximumPropertyChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            if (o is DecimalBox TextBox)
                TextBox.OnMaximumPropertyChanged((decimal)e.OldValue, (decimal)e.NewValue);
        }

        protected void OnMaximumPropertyChanged(decimal oldValue, decimal newValue)
        { }

        private static void IncrementPropertyChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            if (o is DecimalBox TextBox)
                TextBox.OnIncrementPropertyChanged((decimal)e.OldValue, (decimal)e.NewValue);
        }

        protected void OnIncrementPropertyChanged(decimal oldValue, decimal newValue)
        { }

        private static void ValuePropertyChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            if (o is DecimalBox TextBox)
                TextBox.OnValuePropertyChanged((decimal)e.OldValue, (decimal)e.NewValue);
        }

        protected void OnValuePropertyChanged(decimal oldValue, decimal newValue)
        {
            if (newValue > Maximum)
            {
                Value = Maximum;
        ...
        {
            DecimalBox source = d as DecimalBox;
